package br.org.pti.integrador.infrastructure.utils.components;
...
public class RandomCodeGenerator {
     ...
     */
    public static long numericCode(int length) {
        return Long.valueOf(RandomCodeGenerator.generate(length, RandomCodeGenerator.NUMERIC));
    }
