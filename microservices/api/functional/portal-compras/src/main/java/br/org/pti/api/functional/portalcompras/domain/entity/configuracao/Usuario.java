...
@AuditTable(value = "usuario" + ComprasApplication.AUDIT_SUFFIX, schema = ComprasApplication.CONFIGURACAO + ComprasApplication.AUDIT_SUFFIX)
...
//        return email != null ? email.substring(0, email.indexOf("@")) : null;
    ...
    public Set<GrantedAuthority> getAuthorities() {
        ...
        if (administrador)
            return new HashSet<>(Collections.singletonList((GrantedAuthority) () -> Roles.ADMINISTRADOR));
        ...
        if (!getIsFornecedor()) {
            ...
            return new HashSet<>(Arrays.asList((GrantedAuthority) () -> Roles.FORNECEDOR_GET_ROLE, (GrantedAuthority) () -> Roles.FORNECEDOR_PUT_ROLE));
