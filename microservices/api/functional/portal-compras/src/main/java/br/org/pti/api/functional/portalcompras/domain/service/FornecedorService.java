...
import br.org.pti.api.functional.portalcompras.domain.repository.mail.IFornecedorAbstractMailRepository;
import br.org.pti.api.functional.portalcompras.domain.repository.mail.IUsuarioAbstractMailRepository;
import br.org.pti.api.functional.portalcompras.domain.repository.reports.ICRCReportRepository;
import br.org.pti.api.functional.portalcompras.domain.repository.rest.ICNPJRestRepository;
import br.org.pti.api.functional.portalcompras.domain.repository.rest.ICidadesFeignRepository;
import br.org.pti.api.functional.portalcompras.domain.repository.rest.IFornecedoresFeignRepository;
...
public class FornecedorService {
    ...
    public String listByFilters(final Fornecedor fornecedor) {
        return Objects.requireNonNull(cidadesFeignRepository.listByFilters(fornecedor.getEndereco().getCidade().getEstado().getUf())).stream()
                .filter(cidade ->
                        cidade.getNome().equals(Utils.normalizeSymbolsAndAccents(fornecedor.getEndereco().getCidade().getNome()).toUpperCase())
                )
