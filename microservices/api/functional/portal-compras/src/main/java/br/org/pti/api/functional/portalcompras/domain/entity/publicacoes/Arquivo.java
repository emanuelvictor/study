...
import br.org.pti.api.functional.portalcompras.domain.entity.publicacoes.generic.AbstractArquivo;
...
@AuditTable(value = "arquivo" + ComprasApplication.AUDIT_SUFFIX, schema = ComprasApplication.PUBLICACAO + ComprasApplication.AUDIT_SUFFIX)
