...
import br.org.pti.compras.domain.entity.endereco.Endereco;
...
@AuditTable(value = "fornecedor" + AUDIT_SUFFIX, schema = FORNECEDOR + AUDIT_SUFFIX)
public class Fornecedor extends AbstractEntity {
    ...
    @CollectionTable(schema = FORNECEDOR)
    @AuditJoinTable(schema = FORNECEDOR + AUDIT_SUFFIX)
...
//    @EqualsAndHashCode.Exclude
    ...
    @JoinTable(
            schema = FORNECEDOR, name = "atividade_economica_primaria",
...
//    @NotAudited
    @AuditJoinTable(
            schema = FORNECEDOR + AUDIT_SUFFIX, name = "atividade_economica_primaria" + AUDIT_SUFFIX
//            ,
//            inverseJoinColumns = {@JoinColumn(name = "atividade_economica_id", nullable = false)}
    )
    ...
    //    @EqualsAndHashCode.Exclude
    @ManyToMany(fetch = FetchType.EAGER, cascade = CascadeType.MERGE)
    @JoinTable(schema = FORNECEDOR, name = "atividade_economica_secundaria",
            joinColumns = {@JoinColumn(name = "fornecedor_id", nullable = false)},
            inverseJoinColumns = {@JoinColumn(name = "atividade_economica_id", nullable = false)},
            uniqueConstraints = {@UniqueConstraint(columnNames = {"fornecedor_id", "atividade_economica_id"})}
    )
    //    @NotAudited
    @AuditJoinTable(schema = FORNECEDOR + AUDIT_SUFFIX, name = "atividade_economica_secundaria" + AUDIT_SUFFIX
//            ,
//            inverseJoinColumns = {@JoinColumn(name = "atividade_economica_id", nullable = false)}
    )
    ...
    public void setRazaoSocial(final String razaoSocial) {
        this.razaoSocial = razaoSocial != null ? razaoSocial.replaceAll(REGEX_TO_REMOVE_ESPECIAL_CHARACTERS_TO_PROTHEUS, "").toUpperCase().trim() : null;
    }
