...
public class UsuarioResource {
     ...
     */
    @GetMapping
    @PreAuthorize("hasAnyAuthority('" + USUARIO_GET_ROLE + "', '" + ADMINISTRADOR + "')")
     ...
     */
    @PostMapping
    @PreAuthorize("hasAnyAuthority('" + USUARIO_POST_ROLE + "', '" + ADMINISTRADOR + "')")
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('" + USUARIO_PUT_ROLE + "', '" + ADMINISTRADOR + "')")
     ...
     */
    @PutMapping("/ativo")
    @PreAuthorize("hasAnyAuthority('" + USUARIO_PUT_ACTIVATE_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PreAuthorize("hasAnyAuthority('" + USUARIO_PUT_CHANGE_PASSWORD_ROLE + "', '" + ADMINISTRADOR + "')")
