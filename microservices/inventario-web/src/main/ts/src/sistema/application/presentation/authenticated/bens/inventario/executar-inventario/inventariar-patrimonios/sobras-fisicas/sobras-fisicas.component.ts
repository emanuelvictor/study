...
import {InserirSobraFisicaComponent} from "./inserir-sobra-fisica/inserir-sobra-fisica.component";
import {AlterarSobraFisicaComponent} from "./alterar-sobra-fisica/alterar-sobra-fisica.component";

// @ts-ignore
@Component({
  selector: 'sobras-fisicas',
  templateUrl: './sobras-fisicas.component.html',
  styleUrls: ['../../../inventarios.scss'],
  animations: [
    viewAnimation
  ]
})
export class SobrasFisicasComponent implements OnChanges{
  ...
  public listByFilters(descricaoPatrimonioFilter?: string, descricaoLocalizacaoFilter?: string, numeroPlaquetaFilter?: string) {
    this.patrimonioRepository.listSobrasFisicasByCentroCustoCodigoAndFilters({
   ...
   * @param patrimonio
   */
  openAlterarSobraFisicaDialog(patrimonio: PatrimonioDTO) {
    return this.dialog.open(AlterarSobraFisicaComponent, {
      width: 'auto',
      height: 'auto',
      maxHeight: '600px',
      data: {patrimonio}
   ...
   */
  openInserirSobraFisicaDialog(centroCustoInventario: CentroCustoInventario) {
    return this.dialog.open(InserirSobraFisicaComponent, {
      width: 'auto',
      height: 'auto',
      maxHeight: '600px',
