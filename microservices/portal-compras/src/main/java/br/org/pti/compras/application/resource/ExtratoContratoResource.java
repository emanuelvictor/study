...
import br.org.pti.compras.domain.entity.publicacoes.ExtratoContrato;
import br.org.pti.compras.domain.entity.publicacoes.InstrumentoJuridico;
import br.org.pti.compras.domain.repository.IAnexoRepository;
import br.org.pti.compras.domain.repository.IExtratoContratoRepository;
...
@RestController
@RequestMapping({EXTRATO_CONTRATO_MAPPING_RESOURCE, "/sistema/" + EXTRATO_CONTRATO_MAPPING_RESOURCE})
...
//    @PreAuthorize("hasAnyAuthority('" + EXTRATO_CONTRATO_GET_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('" + EXTRATO_CONTRATO_POST_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('" + EXTRATO_CONTRATO_PUT_ROLE + "' , '" + ADMINISTRADOR + "')")
