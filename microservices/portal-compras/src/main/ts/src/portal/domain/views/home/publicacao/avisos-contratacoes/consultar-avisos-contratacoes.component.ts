...
export class ConsultarAvisosContratacoesComponent implements OnInit {
   ...
   */
  dataSource = new MatTableDataSource<AvisoContratacao>();

  constructor(private avisoContratacaoRepository: AvisoContratacaoRepository, private activatedRoute: ActivatedRoute,) {
