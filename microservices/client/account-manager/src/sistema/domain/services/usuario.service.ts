...
export class UsuarioService {
   ...
   */
  constructor(private http: HttpClient, private usuarioRepository: UsuarioRepository) {
  }
   ...
   * @param username
   */
  public findByLdapUsername(username: string): Observable<Usuario> {
    return this.usuarioRepository.findByLdapUsername(username);
  }
