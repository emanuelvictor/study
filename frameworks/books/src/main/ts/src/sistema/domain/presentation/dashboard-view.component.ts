...
export class DashboardViewComponent implements OnInit, OnDestroy {
  ...
  constructor(private translate: TranslateService,
    ...
    this.matrix = {
      ...
      '/publicacoes': ['administrador', 'avisos-contratacoes', 'avisos-contratacoes/get', 'avisos-editais', 'avisos-editais/get', 'extratos-contratos', 'extratos-contratos/get'],
      '/cadastros': ['administrador', 'categorias', 'categorias/get', 'tipos-documentos', 'tipos-documentos/get', 'tipos-cadastros', 'tipos-cadastros/get']
    };
