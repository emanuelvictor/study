...
import br.org.pti.integrador.domain.entities.contabilidade.LancamentoContabil;
import br.org.pti.integrador.domain.entities.contabilidade.StatusConciliacao;
import br.org.pti.integrador.domain.entities.dto.LancamentoViagemValorDTO;
...
public interface LancamentoContabilRepository extends ProtheusRepository<LancamentoContabil, Long> {
     ...
     */
    @Query(value = "SELECT new br.org.pti.integrador.domain.entities.dto.LancamentoViagemValorDTO("
            + "   l.valor, "
            + "   CASE "
