...
export class PatrimonioFormComponent extends CrudViewComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      plaqueta: new FormControl(
        {
          ...
          disabled: this.entity && this.entity.id
        },
        [obrigatorio()]
      ),
    ...
    if (!this.entity.localizacaoAnterior)
      this.entity.localizacaoAnterior = Object.assign({}, this.entity.localizacao)
  }
    ...
    if (this.entity.localizacao && this.entity.localizacao.length >= 3) {
      ...
      await this.patrimonioRepository.listByLocalizacoesFilters({
        ...
        if (this.localizacoes.length && this.entity.localizacao)
          if (this.localizacoes[0] && this.localizacoes[0].codigo && this.localizacoes[0].codigo.toLocaleLowerCase() === ((this.entity.localizacao.constructor === String) && (this.entity.localizacao as any).toLowerCase()))
