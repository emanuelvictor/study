...
import br.org.pti.compras.domain.entity.publicacoes.AvisoEdital;
import br.org.pti.compras.domain.entity.publicacoes.Status;
import br.org.pti.compras.domain.repository.IAnexoRepository;
import br.org.pti.compras.domain.repository.IAvisoEditalRepository;
import br.org.pti.compras.domain.repository.ICategoriaAvisoEditalRepository;
...
@RestController
@RequestMapping({AVISO_EDITAL_MAPPING_RESOURCE, "/sistema/" + AVISO_EDITAL_MAPPING_RESOURCE})
...
//    @PreAuthorize("hasAnyAuthority('" + AVISO_EDITAL_GET_ROLE + "' , '" + ADMINISTRADOR + "')")
    public Page<AvisoEdital> listByFilters(final String defaultFilter, final Long[] categoriasFilter, final Status status,
        ...
        final Page<AvisoEdital> avisoEditais = this.avisoEditalRepository.listByFilters(defaultFilter, getListFromArray(categoriasFilter), status, min, max, pageable);
...
//    @PreAuthorize("hasAnyAuthority('" + AVISO_EDITAL_GET_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('" + AVISO_EDITAL_POST_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('" + AVISO_EDITAL_PUT_ROLE + "' , '" + ADMINISTRADOR + "')")
