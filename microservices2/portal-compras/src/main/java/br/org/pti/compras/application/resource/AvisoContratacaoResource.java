...
import br.org.pti.compras.domain.entity.publicacoes.AvisoContratacao;
import br.org.pti.compras.domain.entity.publicacoes.Modalidade;
import br.org.pti.compras.domain.repository.IAnexoRepository;
import br.org.pti.compras.domain.repository.IAvisoContratacaoRepository;
...
@RestController
@RequestMapping({AVISO_CONTRATACAO_MAPPING_RESOURCE, "/sistema/" + AVISO_CONTRATACAO_MAPPING_RESOURCE})
...
//    @PreAuthorize("hasAnyAuthority('" + AVISO_CONTRATACAO_GET_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyAuthority('" + AVISO_CONTRATACAO_POST_ROLE + "', '" + ADMINISTRADOR + "')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('" + AVISO_CONTRATACAO_PUT_ROLE + "' , '" + ADMINISTRADOR + "')")
